...
link.f_fix.on.k <- list(
  mu = \(x) gamma_t(x, 0.1, 0.1),
  K = \(x) loggaus_t(x, log(0.15), 0.0001),
  alpha = \(x) unif_t(x, 0, 10),
  c_ = \(x) unif_t(x, 0, 10),
  p = \(x) unif_t(x, 1, 10)
)
...
inv.link.f_fix.on.k <- list(
  mu = \(x) inv_gamma_t(x, 0.1, 0.1),
  K = \(x) inv_loggaus_t(x, log(0.15), 0.0001),
  alpha = \(x) inv_unif_t(x, 0, 10),
  c_ = \(x) inv_unif_t(x, 0, 10),
  p = \(x) inv_unif_t(x, 1, 10)
)
...
link.f_mis.k <- list(
  mu = \(x) gamma_t(x, 0.1, 0.1),
  K = \(x) loggaus_t(x, log(1.5), 0.0001),
  alpha = \(x) unif_t(x, 0, 10),
  c_ = \(x) unif_t(x, 0, 10),
  p = \(x) unif_t(x, 1, 10)
)
...
inv.link.f_mis.k <- list(
  mu = \(x) inv_gamma_t(x, 0.1, 0.1),
  K = \(x) inv_loggaus_t(x, log(1.5), 0.0001),
  alpha = \(x) inv_unif_t(x, 0, 10),
  c_ = \(x) inv_unif_t(x, 0, 10),
  p = \(x) inv_unif_t(x, 1, 10)
)
...
inv.link.f_mis.mu <- list(
  ...
  alpha = \(x) inv_loggaus_t(x, -1, 2.03),
  c_ = \(x) inv_unif_t(x, 0, 10),
  p = \(x) inv_unif_t(x, 1, 10)
)
