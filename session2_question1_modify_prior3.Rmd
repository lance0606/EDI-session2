...
bind.post.df.g1.good <- rbind(post.list.g1[[2]]$post.df,post.list.g1[[7]]$post.df,
                              post.list.g1[[9]]$post.df)
...
gg1<-ggplot(post.df.alpha.g1, aes(x = x, y = y, color = cat.used)) +
  ...
  annotate("text", x = 5.5, y = 5, label = "All Cases")+
  annotate("rect", xmin = 5.3, xmax = 5.7, ymin = 4.8, ymax = 5.2,alpha = .2)
...
gg2<-ggplot(post.df.alpha.g1.good, aes(x = x, y = y, color = cat.used)) +
  ...
  annotate("text", x = 3, y = 5, label = "Good Cases")+
  annotate("rect", xmin = 2.94, xmax = 3.06, ymin = 4.8, ymax = 5.2,alpha = .2)
...
bind.post.df.g3.good <- rbind(post.list.g3[[1]]$post.df,post.list.g3[[7]]$post.df,
                              post.list.g3[[8]]$post.df)
...
gg2<-ggplot(post.df.alpha.g3.good, aes(x = x, y = y, color = cat.used)) +
  ...
  annotate("text", x = 3.2, y = 5, label = "Good Cases")+
  annotate("rect", xmin = 3.1, xmax = 3.3, ymin = 4.8, ymax = 5.2,alpha = .2)
...
gg1<-ggplot(post.df.alpha.list[[1]], aes(x = x, y = y, color = cat.used)) +
  ...
  annotate("text", x = 3.5, y = 7, label = "3 events")
...
gg2<-ggplot(post.df.alpha.list[[2]], aes(x = x, y = y, color = cat.used)) +
  ...
  annotate("text", x = 5.5, y = 7, label = "4 events")
...
gg3<-ggplot(post.df.alpha.list[[3]], aes(x = x, y = y, color = cat.used)) +
  ...
  annotate("text", x = 4, y = 7, label = "5 events")
...
gg4<-ggplot(post.df.alpha.list[[4]], aes(x = x, y = y, color = cat.used)) +
  ...
  annotate("text", x = 2.8, y = 5, label = "6 events")
...
gg5<-ggplot(post.df.alpha.list[[5]], aes(x = x, y = y, color = cat.used)) +
  ...
  annotate("text", x = 3, y = 6, label = "7 events")
...
gg6<-ggplot(post.df.alpha.list[[6]], aes(x = x, y = y, color = cat.used)) +
  ...
  annotate("text", x = 3, y = 7, label = "8 events")
